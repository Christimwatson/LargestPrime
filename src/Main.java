public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(LargestPrime.getLargestPrime(105023));
        System.out.println(LargestPrime.getLargestPrime(21346));
        System.out.println(LargestPrime.getLargestPrime(85279));
